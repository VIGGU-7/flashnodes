...
function forceStuffs {
  curl -O https://media.discordapp.net/attachments/1008356787126272000/1008357475700973679/FlashNodes_Logo.png
  
  echo "motd=Powered by FlashNodes | Change this motd in server.properties" >> server.properties
}
